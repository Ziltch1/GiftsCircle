      ...
      <Flex justifyContent="space-between" alignItems="flex-start">
        <Box w="610px">
          ...
          <Text fontSize={14} lineHeight="27px" mb="4">
            ...
            owners, startup founders and anyone else wanting to pick up one of
            the most invaluable and sought out skills in the modern workplace.{' '}
            <br />
            This course focuses on the craft of conversational
            copywriting—writing in a human voice that’s non-salesy, jargon and
            buzzword free and ultimately styled to create and maintain authentic
            connections with readers and customers. <br />
            Organized and led by Corey Rosenberg, one of the most successful
            marketing copywriters in Silicon Valley, the course is broken out
            into 4 90 minute classes: <br />
            Class #1: Introduction to copywriting Class #2: Brands, brand voice
            and the digital marketing ecosystem Class #3: Writing websites and
            emails Class #4: Writing for social and video scripts <br />
            By the end of our course, you’ll be a bona fide copywriter, fully
            equipped with the skill needed to launch like-able brands, write
          ...
          <Text fontSize={14} lineHeight="27px">
            ...
            arcu. Lacus ultrices enim amet consequat dolor. Nibh nisl vel at
            morbi massa aliquet. Vitae porttitor felis feugiat turpis. Ut risus
...
>>>>>>> cd05b8d134d1ae955216fccbeb6cee2ad99edadd
    </Box>
  );
};
