          ...
          <Box>
            ...
            <ModalBody>
              ...
              <Box textAlign='center' mb='4'>
                <Heading fontWeight={600} fontSize='25px' mb='3'>Cancel Event!</Heading>
                <Text fontSize={14}>Are you sure you want to cancel this event?</Text>
              </Box>

              <Box textAlign='center'>
                <Link to='/dashboard'>
                  <Button fontWeight='medium' fontSize={14} color='white' bg='#00BFB2'>Yes cancel event</Button>
                </Link>
              </Box>
            </ModalBody>
          </Box>
