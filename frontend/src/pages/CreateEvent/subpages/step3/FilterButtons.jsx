  ...
  return (
    <Box mb='7'>
      ...
      <Flex justifyContent='space-between'>
        ...
        <HStack spacing={3}>
          {buttons.map((btn) => 
          <Button fontWeight='semibold' fontSize='12px' w='100px' bg='none' border='1.5px solid gray' _hover={{ bg: '#00BFB2', color: 'white', border: '1px solid #00BFB2', boxShadow: '0px 8px 30px rgba(0, 191, 178, 0.1)'}}>
            {btn}
          </Button>)}
        </HStack>
      </Flex>
