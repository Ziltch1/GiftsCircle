      ...
      <Flex mb='5' alignItems='center' justifyContent='space-between'>
        ...
        <Box>
          <Flex alignItems='center' gap={4}>
            <Button fontSize={14} fontWeight='medium' w='170px' h='44px' display='flex' alignItems='center' justifyContent='space-around' bg='#CCF2F0' boxShadow='0px 8px 30px rgba(0, 191, 178, 0.1)' onClick={showDrawer}>
