                ...
                <FormControl>
                    <Box mb='5'>
                        <FormLabel fontWeight='semibold' fontSize={13.5}>Event title</FormLabel>
                          <Input type='text' placeholder='Enter the name of the event' fontSize={14} bg='#FAFAFA' color='black' _placeholder={{ color: '#8C8C8C' }} />
                    </Box>
                    ...
                    <Box mb='8'>
                        ...
                        <Select type='text' placeholder='Select your category' fontSize={14} bg='#FAFAFA' color='black' _placeholder={{ color: '#8C8C8C' }}>
                    ...
                    <Box mb='8'>
                        ...
                        <Input type='text' placeholder='e.g 26, Beside Mouka foam, Mokola, Ibadan' fontSize={14} bg='#FAFAFA' color='black' _placeholder={{ color: '#8C8C8C' }} />
                    </Box>
                    ...
                    <Box mb='7'>
                        ...
                        <Input type='date' fontSize={14} bg='#FAFAFA' color='black' _placeholder={{ color: '#8C8C8C' }} />
                    </Box>
                    ...
                    <Box mb='5'>
                        ...
                        <Flex justifyContent='space-between'>
                            <Box w='240px'>
                                ...
                                <Input type='time' placeholder='Start time' fontSize={14} bg='#FAFAFA' color='black' _placeholder={{ color: '#8C8C8C' }} />
                            </Box>
                            <Box w='240px'>
